...
<section class="inner-banner py-5">
  <style>
    .inner-banner {
      background-image: url(<?php if(get_theme_mod('BlogPageBannerBgImage') !='') {
  ...
  <div class="w3l-breadcrumb py-lg-5">
    <div class="container BlogPageBanner">
      <?php $BlogPageMainTitleStatus = get_theme_mod( "BlogPageMainTitleRequired","1")?>
      <?php if( $BlogPageMainTitleStatus==1 ){?>
      <h4 class="inner-text-title font-weight-bold pt-5">
        <?php echo get_theme_mod( "BlogPageBannerMainTitle" );if(get_theme_mod( "BlogPageBannerMainTitle" )==''){echo 'Blog Posts';}?></h4>
      <?php }?>
