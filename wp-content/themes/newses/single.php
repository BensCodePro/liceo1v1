                                  ...
                                  <div class="small-post media col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="small-post-content media-body">
                                      <?php $newses_enable_single_post_category = esc_attr(get_theme_mod('newses_enable_single_post_category','true'));
                                            ...
                                            if($newses_enable_single_post_category == true){ newses_post_categories(); } ?>
                                        <!-- small-post-content -->
                                        ...
                                        <!-- // title_small_post -->
                                           <div class="mg-blog-meta"> 
                                            ...
                                            <?php } ?> 
                                            <?php edit_post_link( __( 'Edit', 'newses' ), '<span class="post-edit-link"><i class="fa-regular fa-pen-to-square"></i>', '</span>' ); ?>
                                          </div>
                                    </div>
                                  </div>
                                    <!-- blog -->
